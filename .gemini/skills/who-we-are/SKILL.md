...
name: who-we-are
description: v1.5.73 L-SKLL | Know ourselves - show identity, model info, session stats, and Oracle philosophy. Use when user asks "who we are", "who", or wants to check current AI identity.
---
