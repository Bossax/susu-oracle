...
status: current
tags: []
created: 2026-01-28T08:24:58.000Z
last_updated:
AI_prompt: false
project:
  - DCCE_CRI
...
- **Annotation:** Disaster risk reduction is the policy objective of disaster risk management, and its goals and objectives are defined in disaster risk reduction strategies and plans.
...
<!--note: Preparedness is a whole picture of disaster risk management. It focuses on knowledge and capacities needed for the whole DRM cycle, from anticipation to recovery-->

<!--note:  Readiness is more action-oriented. It focuses on the 'response' phase of DRM. Good readiness implies good response-->
# Capacity
