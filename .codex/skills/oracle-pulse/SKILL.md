...
name: oracle-pulse
description: v1.5.73 L-SKLL | Quantitative heartbeat from ~/.claude/ session data. Use when user says "pulse", "stats", "usage", "how much have I used", "session count", "activity".
